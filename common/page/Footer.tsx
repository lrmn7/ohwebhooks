...
export function Footer() {
  return (
    <Container>
      <BrandContainer>
        {monochromeLogo}
        <BrandName>Oh!Webhooks</BrandName>
      </BrandContainer>
      <Tagline>The easiest way to personalise your Discord server.</Tagline>
      <Info>Email: &quot;hello&quot; at ohwebhooks.app</Info>
      <NavigationList>
        ...
        <NavigationItem href="https://git.io/lrmn7" target="_blank">
          Source Code
        </NavigationItem>
        <NavigationItem href="https://patreon.com/LRMN" target="_blank">
          Support Oh!Webhooks
        </NavigationItem>
      </NavigationList>
      <LegalInfo>
        &copy; 2021 The Oh!Webhooks Authors. Oh!Webhooks is not affiliated with
        Discord.
      </LegalInfo>
      <LegalInfo>

...
export function PageHead(props: PageHeadProps) {
  ...
  return (
    <Head>
      ...
      />
      <title key="title">
        {title === "Oh!Webhooks" ? title : `${title} • Oh!Webhooks`}
      </title>
      ...
      <meta
        key="og:url"
        property="og:url"
        content={`https://ohwebhooks.hop.sh${router.pathname}`}
      />
      <meta
        key="og:description"
        ...
        content={description}
      />
      <meta key="og:site_name" property="og:site_name" content="Oh!Webhooks" />
      <link
        key="canonical"
        rel="canonical"
        href={`https://ohwebhooks.hop.sh${router.pathname}`}
      />
      {links.map(link => (

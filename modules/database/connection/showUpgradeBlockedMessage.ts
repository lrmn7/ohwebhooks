export const showUpgradeBlockedMessage = () => {
  ...
  header.append("Oh!Webhooks's local database needs an upgrade")

  const blockedMessage = document.createElement("p")
  blockedMessage.append(
    "However, the upgrade can't proceed because there are older sessions of Oh!Webhooks open.",
  )

  const closeTabsMessage = document.createElement("p")
  closeTabsMessage.append("Please close all Oh!Webhooks tabs before continuing.")
